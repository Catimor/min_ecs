...
//! minecs!(
//! 	// optionally: #[derive( serde::Serialize, serde::Deserialize )]
//! 	world MinEcs;
//! 	entity TestEntity ( f64, usize, /* --ect-- */ )
//! 	{
//! 		named_fld: usize, // trailing comma is optional
//! 	}
//! );
//! 
//! /*
...
//! # Recommendation
//! 
//! Due to lacking macro hygiene all of the types and traits need to be in scope when calling `minecs!`.
//! It is thus recommended to create a separate, `pub`lic module which will re-export both min_ecs types and ones generated by macro.
//! ```
//! pub mod ecs {
//! 	pub use min_ecs::*;
...
//! 	
//! 	minecs!(
//! 		/* optional derive attribute */
//! 		world MinEcs;
//! 		entity TestEntity ( f64, usize, /* --ect-- */ )
//! 		{
//! 			some_fld: std::collections::HashMap< std::rc::Rc< str >, usize >,
//! 		}
//! 	);
//! }
//! ```
